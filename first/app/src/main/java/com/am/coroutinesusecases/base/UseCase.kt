package com.am.coroutinesusecases.base

import android.os.Parcelable
import androidx.appcompat.app.AppCompatActivity
import com.am.coroutinesusecases.usecases.channels.usecase1.ChannelUseCase1Activity
import com.am.coroutinesusecases.usecases.coroutines.usecase1.PerformSingleNetworkRequestActivity
import com.am.coroutinesusecases.usecases.coroutines.usecase10.CalculationInBackgroundActivity
import com.am.coroutinesusecases.usecases.coroutines.usecase11.CooperativeCancellationActivity
import com.am.coroutinesusecases.usecases.coroutines.usecase12.CalculationInSeveralCoroutinesActivity
import com.am.coroutinesusecases.usecases.coroutines.usecase13.ExceptionHandlingActivity
import com.am.coroutinesusecases.usecases.coroutines.usecase14.ContinueCoroutineWhenUserLeavesScreenActivity
import com.am.coroutinesusecases.usecases.coroutines.usecase15.WorkManagerActivity
import com.am.coroutinesusecases.usecases.coroutines.usecase16.PerformanceAnalysisActivity
import com.am.coroutinesusecases.usecases.coroutines.usecase17.PerformCalculationOnMainThreadActivity
import com.am.coroutinesusecases.usecases.coroutines.usecase2.Perform2SequentialNetworkRequestsActivity
import com.am.coroutinesusecases.usecases.coroutines.usecase2.callbacks.SequentialNetworkRequestsCallbacksActivity
import com.am.coroutinesusecases.usecases.coroutines.usecase2.rx.SequentialNetworkRequestsRxActivity
import com.am.coroutinesusecases.usecases.coroutines.usecase3.PerformNetworkRequestsConcurrentlyActivity
import com.am.coroutinesusecases.usecases.coroutines.usecase4.VariableAmountOfNetworkRequestsActivity
import com.am.coroutinesusecases.usecases.coroutines.usecase5.NetworkRequestWithTimeoutActivity
import com.am.coroutinesusecases.usecases.coroutines.usecase6.RetryNetworkRequestActivity
import com.am.coroutinesusecases.usecases.coroutines.usecase7.TimeoutAndRetryActivity
import com.am.coroutinesusecases.usecases.coroutines.usecase7.callbacks.TimeoutAndRetryCallbackActivity
import com.am.coroutinesusecases.usecases.coroutines.usecase7.rx.TimeoutAndRetryRxActivity
import com.am.coroutinesusecases.usecases.coroutines.usecase8.RoomAndCoroutinesActivity
import com.am.coroutinesusecases.usecases.coroutines.usecase9.DebuggingCoroutinesActivity
import com.am.coroutinesusecases.usecases.flow.usecase1.FlowUseCase1Activity
